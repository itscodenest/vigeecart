   ...
   <div class="alert alert-success d-print-none" role="alert">
    ...
    <div class="card">
        ...
        <div class="row">
          ...
          <img src="https://img3.stockfresh.com/files/w/wywenka/m/81/2163059_stock-photo-healthy-food-menu-background-vegetable-vector-illustration.jpg" class="logo mr-2 mb-4 float-left"/>
          </div>
